...
function billing() {
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
    ...
    <div className="rounded-2xl bg-white border hover:bg-blue-300 border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
      ...
      <ul className="mt-6 space-y-2">
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700"> 10,00000 Words/Month </span>
        </li>
        ...
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700"> 25+ Content Templates </span>
        </li>
    ...
    <div className="rounded-2xl bg-lightblack border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
      <div className="text-center">
        <h2 className="text-lg font-medium text-gray-900">
          Monthly
          <span className="sr-only">Plan</span>
      ...
      <ul className="mt-6 space-y-2">
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700"> 10,000,000 Words/Month  </span>
        </li>
